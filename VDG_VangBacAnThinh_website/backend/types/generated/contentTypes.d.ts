...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    position: Schema.Attribute.Enumeration<['hero', 'sub', 'promo']> &
      Schema.Attribute.Required &
...
export interface ApiGoldHistoryGoldHistory extends Struct.CollectionTypeSchema {
  collectionName: 'gold_histories';
  info: {
    displayName: 'Gold History';
    pluralName: 'gold-histories';
    singularName: 'gold-history';
  };
  options: {
    comment: '';
    draftAndPublish: false;
  ...
  attributes: {
    buyPrice: Schema.Attribute.Decimal;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    goldName: Schema.Attribute.String;
    goldType: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::gold-history.gold-history'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    recordDate: Schema.Attribute.String;
    sellPrice: Schema.Attribute.Decimal;
...
export interface ApiGoldPriceGoldPrice extends Struct.CollectionTypeSchema {
  collectionName: 'gold_prices';
  info: {
    description: 'Company gold buy/sell prices';
  ...
  attributes: {
    buyPrice: Schema.Attribute.Decimal & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    goldName: Schema.Attribute.String & Schema.Attribute.Required;
    goldType: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sellPrice: Schema.Attribute.Decimal & Schema.Attribute.Required;
    sortOrder: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    unit: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'VN\u0110/l\u01B0\u1EE3ng'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Jewelry and gold products';
    displayName: 'Product';
    pluralName: 'products';
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    address: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'S\u1ED1 141P Tr\u01B0\u01A1ng \u0110\u1ECBnh, Ph\u01B0\u1EDDng T\u01B0\u01A1ng Mai, H\u00E0 N\u1ED9i'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    ...
    phone: Schema.Attribute.String & Schema.Attribute.DefaultTo<'0363778889'>;
    publishedAt: Schema.Attribute.DateTime;
    siteName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'V\u00E0ng An Th\u1ECBnh'>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::gold-history.gold-history': ApiGoldHistoryGoldHistory;
